...
setup(
    ...
    packages=['multimodalsim', 'multimodalsim.config',
              ...
              'multimodalsim.state_machine', 'multimodalsim.statistics','multimodalsim.shuttle','multimodalsim.communication'],
    ...
    install_requires=['pip', 'setuptools', 'networkx', 'numpy', 'pandas',
                      'requests', 'polyline', 'pyproj','stomp.py', 'psycopg2-binary', 'matplotlib']
)
