...
export class StopsFileModalComponent {
	constructor(private dataReaderService: DataReaderService, private simulationParserService: SimulationParserService, private stopPositionHandlerService: StopPositionHandlerService) {}
	closeModal(): void {
